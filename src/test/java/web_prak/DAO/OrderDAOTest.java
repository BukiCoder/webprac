...
public class OrderDAOTest {
    ...
    void cleanDatabase() {
        try (Session session = sessionFactory.openSession()) {
            ...
            session.createNativeQuery("TRUNCATE \"order\" RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE car RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE car_configuration RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE model RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE brand RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE client RESTART IDENTITY CASCADE;").executeUpdate();
            session.createNativeQuery("TRUNCATE manager RESTART IDENTITY CASCADE;").executeUpdate();

            session.createNativeQuery("ALTER SEQUENCE \"order_id_seq\" RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE car_id_seq RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE car_configuration_id_seq RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE model_id_seq RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE brand_id_seq RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE client_id_seq RESTART WITH 1;").executeUpdate();
            session.createNativeQuery("ALTER SEQUENCE manager_id_seq RESTART WITH 1;").executeUpdate();
