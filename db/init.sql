...
INSERT INTO car_configuration (
    ...
    drive_type, is_sales_stopped, additional_properties
) VALUES
    (1, 'Comfort', 'Petrol', 150, 2.5, 7.8, 'Petrol', 60, TRUE, 27000, 5, 4, 'Automatic', 'Front', FALSE, '{"color_options": ["white", "black", "silver"]}'),
    (1, 'Luxury', 'Petrol', 200, 3.5, 9.2, 'Petrol', 60, TRUE, 35000, 5, 4, 'Automatic', 'Front', FALSE, '{"color_options": ["black", "blue"], "leather": true}'),
    (2, 'Diesel', 'Diesel', 190, 2.0, 6.5, 'Diesel', 55, TRUE, 42000, 5, 5, 'Automatic', 'All-wheel', FALSE, '{"roof_rails": true}'),
    (3, 'Base', 'Petrol', 123, 1.6, 6.9, 'Petrol', 50, FALSE, 18000, 5, 4, 'Manual', 'Front', FALSE, '{}'),
    (4, 'Sport', 'Petrol', 250, 2.0, 8.5, 'Petrol', 52, TRUE, 28000, 5, 5, 'Automatic', 'Front', FALSE, '{"sport_package": true}');
